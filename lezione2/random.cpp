...
//La seguente funzione genera numeri con distribuzione di probabilità p(x)
// = 2*(1-x).
//La formula x = 1 - sqrt(1 - Rannyu()) è stata ricavata con il teorema
//della funzione inversa

double Random :: Polinomio(){
   double x = 1 - sqrt(1 - Rannyu());
   return x;
}
